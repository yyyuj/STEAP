...
# installed.
TCL_PREFIX='/STEAP/.snakemake/conda/714e0722'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/STEAP/.snakemake/conda/714e0722'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /STEAP/.snakemake/conda/714e0722/include -fdebug-prefix-map=/croot/tk_1714770549989/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/STEAP/.snakemake/conda/714e0722=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /STEAP/.snakemake/conda/714e0722/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/STEAP/.snakemake/conda/714e0722/lib -Wl,-rpath-link,/STEAP/.snakemake/conda/714e0722/lib -L/STEAP/.snakemake/conda/714e0722/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/STEAP/.snakemake/conda/714e0722/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/STEAP/.snakemake/conda/714e0722/include'
...
TCL_PACKAGE_PATH='{/STEAP/.snakemake/conda/714e0722/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/STEAP/.snakemake/conda/714e0722/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/croot/tk_1714770549989/work/tcl8.6.14/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/STEAP/.snakemake/conda/714e0722/lib/libtclstub8.6.a'
